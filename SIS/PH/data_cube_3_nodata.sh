...
gdal_calc.py --quiet -A PH-SOILP-BD-2024-0-30.tif --outfile=temp.tif --calc="A*(A!=-9999) + ($NODATA)*(A==-9999)" --NoDataValue=$NODATA && mv temp.tif PH-SOILP-BD-2024-0-30.tif 
gdal_calc.py --quiet -A PH-SOILP-BD-2024-30-60.tif --outfile=temp.tif --calc="A*(A!=-9999) + ($NODATA)*(A==-9999)" --NoDataValue=$NODATA && mv temp.tif PH-SOILP-BD-2024-30-60.tif 
gdal_calc.py --quiet -A PH-SOILP-CEC-2024-0-30.tif --outfile=temp.tif --calc="A*(A!=-9999) + ($NODATA)*(A==-9999)" --NoDataValue=$NODATA && mv temp.tif PH-SOILP-CEC-2024-0-30.tif 
gdal_calc.py --quiet -A PH-SOILP-CEC-2024-30-60.tif --outfile=temp.tif --calc="A*(A!=-9999) + ($NODATA)*(A==-9999)" --NoDataValue=$NODATA && mv temp.tif PH-SOILP-CEC-2024-30-60.tif 
gdal_calc.py --quiet -A PH-SOILP-CLAY-2024-0-30.tif --outfile=temp.tif --calc="A*(A!=-9999) + ($NODATA)*(A==-9999)" --NoDataValue=$NODATA && mv temp.tif PH-SOILP-CLAY-2024-0-30.tif 
gdal_calc.py --quiet -A PH-SOILP-CLAY-2024-30-60.tif --outfile=temp.tif --calc="A*(A!=-9999) + ($NODATA)*(A==-9999)" --NoDataValue=$NODATA && mv temp.tif PH-SOILP-CLAY-2024-30-60.tif 
gdal_calc.py --quiet -A PH-SOILP-K-2024-0-30.tif --outfile=temp.tif --calc="A*(A!=-9999) + ($NODATA)*(A==-9999)" --NoDataValue=$NODATA && mv temp.tif PH-SOILP-K-2024-0-30.tif 
gdal_calc.py --quiet -A PH-SOILP-K-2024-30-60.tif --outfile=temp.tif --calc="A*(A!=-9999) + ($NODATA)*(A==-9999)" --NoDataValue=$NODATA && mv temp.tif PH-SOILP-K-2024-30-60.tif 
gdal_calc.py --quiet -A PH-SOILP-OC-2024-0-30.tif --outfile=temp.tif --calc="A*(A!=-9999) + ($NODATA)*(A==-9999)" --NoDataValue=$NODATA && mv temp.tif PH-SOILP-OC-2024-0-30.tif 
gdal_calc.py --quiet -A PH-SOILP-OC-2024-30-60.tif --outfile=temp.tif --calc="A*(A!=-9999) + ($NODATA)*(A==-9999)" --NoDataValue=$NODATA && mv temp.tif PH-SOILP-OC-2024-30-60.tif 
gdal_calc.py --quiet -A PH-SOILP-P-2024-0-30.tif --outfile=temp.tif --calc="A*(A!=-9999) + ($NODATA)*(A==-9999)" --NoDataValue=$NODATA && mv temp.tif PH-SOILP-P-2024-0-30.tif 
gdal_calc.py --quiet -A PH-SOILP-P-2024-30-60.tif --outfile=temp.tif --calc="A*(A!=-9999) + ($NODATA)*(A==-9999)" --NoDataValue=$NODATA && mv temp.tif PH-SOILP-P-2024-30-60.tif 
gdal_calc.py --quiet -A PH-SOILP-PH-2024-0-30.tif --outfile=temp.tif --calc="A*(A!=-9999) + ($NODATA)*(A==-9999)" --NoDataValue=$NODATA && mv temp.tif PH-SOILP-PH-2024-0-30.tif 
gdal_calc.py --quiet -A PH-SOILP-PH-2024-30-60.tif --outfile=temp.tif --calc="A*(A!=-9999) + ($NODATA)*(A==-9999)" --NoDataValue=$NODATA && mv temp.tif PH-SOILP-PH-2024-30-60.tif 
gdal_calc.py --quiet -A PH-SOILP-SAND-2024-0-30.tif --outfile=temp.tif --calc="A*(A!=-9999) + ($NODATA)*(A==-9999)" --NoDataValue=$NODATA && mv temp.tif PH-SOILP-SAND-2024-0-30.tif 
gdal_calc.py --quiet -A PH-SOILP-SAND-2024-30-60.tif --outfile=temp.tif --calc="A*(A!=-9999) + ($NODATA)*(A==-9999)" --NoDataValue=$NODATA && mv temp.tif PH-SOILP-SAND-2024-30-60.tif 
gdal_calc.py --quiet -A PH-SOILP-SILT-2024-0-30.tif --outfile=temp.tif --calc="A*(A!=-9999) + ($NODATA)*(A==-9999)" --NoDataValue=$NODATA && mv temp.tif PH-SOILP-SILT-2024-0-30.tif 
gdal_calc.py --quiet -A PH-SOILP-SILT-2024-30-60.tif --outfile=temp.tif --calc="A*(A!=-9999) + ($NODATA)*(A==-9999)" --NoDataValue=$NODATA && mv temp.tif PH-SOILP-SILT-2024-30-60.tif 
