...
cat $PROJECT_DIR/GloSIS/glosis-db/modifications/mod_027.csv | psql -h localhost -p 5432 -d glosis -U glosis -c "COPY core.glosis_db_vocab FROM STDIN WITH (FORMAT CSV, HEADER, NULL '')"
