...
#ISSUE: remove Guide lines for Soil description and insert the reviewd ones from Luis R.L.
...
cat /home/carva014/Work/Code/FAO/GloSIS/glosis-db/versions/glosis-db_vocab.tsv | psql -h localhost -p 5432 -d iso28258 -U glosis -c "COPY core.glosis_db_vocab FROM STDIN WITH (FORMAT CSV, HEADER, DELIMITER E'\t', NULL '')"
